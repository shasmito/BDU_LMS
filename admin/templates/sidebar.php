    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="../view/subjects.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg <?= ($currentpage == 'Subjects') ? 'bg-gray-100' : 'hover:bg-gray-100 group'; ?>">
