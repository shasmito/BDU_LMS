      ...
      <div class="p-6 space-y-8 sm:p-8 lg:p-16">
        ...
        <form class="mt-8 space-y-6" action="includes/admin-login.inc.php" method="post">
          ...
          <div class="flex items-start">
            ...
            <a href="#" onclick="alert('Please contact other administrators for further instructions.');" class="ml-auto text-sm text-green-600 hover:underline">Forget Password?</a>
          </div>
