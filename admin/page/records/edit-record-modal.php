<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto bg-gray-900/50 top-4 md:inset-0 h-modal sm:h-full" id="edit-record-modal" aria-modal="true" role="dialog">
        ...
        <div class="p-6 space-y-6">
          <div class="modal-grid">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <select id="status" name="status" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" required>
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <select id="level" name="level" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" required>
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <select id="year" name="year" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" placeholder="Room" required>
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input id="date" type="date" name="date" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" required>
            </div>
          </div>
        </div>
        <div class="items-center p-6 border-t border-gray-200 rounded-b">
          <button type="submit" name="edit" class="btn-cyan-modal">Update record</button>
        </div>
      </form>
    </div>
  </div>
