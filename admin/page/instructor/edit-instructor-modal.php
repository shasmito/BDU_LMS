        ...
        <div class="p-6 space-y-6">
          <div class="modal-grid">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input id="name" type="text" name="name" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" placeholder="First Name, Middle Name, Last Name" required>
            </div>
            <div class="col-span-6 sm:col-span-3">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input id="address" type="text" name="address" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" placeholder="Address" required>
            </div>
            <div class="col-span-6 sm:col-span-3">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <select id="empstatus" name="empstatus" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none">
