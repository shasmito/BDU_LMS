        ...
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input type="text" name="middlename" class="input-field focus:ring-2 focus:ring-green-600/50 focus:border-green-600 focus:outline-none" placeholder="Middle Name">
            </div>
            <div class="col-span-6 sm:col-span-3">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input type="tel" name="contact" class="input-field focus:ring-2 focus:ring-green-600/50 focus:border-green-600 focus:outline-none" placeholder="01700000000" pattern="[0-9]{11}" required>
            </div>
            <div class="col-span-6 sm:col-span-3">
