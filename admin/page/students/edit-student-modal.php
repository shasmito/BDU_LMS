        ...
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input id="middlename" type="text" name="middlename" class="input-field focus:ring-2 focus:ring-cyan-600/50 focus:border-cyan-600 focus:outline-none" placeholder="Bayani" required>
            </div>
            <div class="col-span-6 sm:col-span-3">
